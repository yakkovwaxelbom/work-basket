...
class Settings:
    ...
    def __init__(self):
        ...
        self.background_img = 'assets/graphics/new_background.png'
        ...
        # player settings
        self.player_img = 'assets/graphics/player_1.png'
        ...
        # bullet settings
        self.bullet_img = 'assets/graphics/shoot_1.png'
        self.enemy_bullet_img = 'assets/graphics/shoot_4.png'
        ...
        # enemy settings
        self.enemy_img = 'assets/graphics/alien.png'
        ...
        self.direction = 1
        self.smash_sound = pygame.mixer.Sound('assets/sounds/smash.mpeg')
        self.enemy_rows = 3
